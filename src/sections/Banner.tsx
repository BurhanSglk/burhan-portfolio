  ...
  return (
    <section id="banner" className="my-8 flex flex-col items-center justify-center">
      <h1 className="mb-4 text-[1.5rem] md:text-[2rem] font-bold">
        <MotionText delayOffset={0}>Hi, I m Burhan Sağlık! 👋</MotionText>
      </h1>
      <MotionDiv>
      ...
      <div className="space-y-4">
        ...
        <MotionDiv delayOffset={1.2}>
          <MotionList delayOffset={1.3}>
            <ContactItem title="Instagram" icon={faInstagram} bgColor="bg-yellow-500" link="https://www.instagram.com/burhan.sglk" />
